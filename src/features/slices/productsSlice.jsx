...
export const productSlice = createSlice({
    ...
    reducers: {
        ...
        sortByPrice(state) {
            try {
                const price = state.filteredProducts.sort((a,b) => a.price > b.price ? -1 : 1)//sort function in js sorts in place that is state.filtered products is now a descending sorted array
